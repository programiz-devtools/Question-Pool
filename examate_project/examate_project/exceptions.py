...
class QuestionValidationError(CustomAPIException):
    
    def __init__(self,error_code):
        super().__init__(error_code)

class OptionValidationError(CustomAPIException):
    
    def __init__(self,error_code):
        super().__init__(error_code)

class OptionLimitException(CustomAPIException):
    
    def __init__(self,error_code):
        super().__init__(error_code)

class NonUpdateable(CustomAPIException):
    
    def __init__(self,error_code):
        super().__init__(error_code)

class MaxStringLength(CustomAPIException):
